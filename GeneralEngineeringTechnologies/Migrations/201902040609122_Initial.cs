namespace GeneralEngineeringTechnologies.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Proggres = c.Int(nullable: false),
                        Description = c.String(),
                        Status = c.String(),
                        Assigne_Id = c.String(maxLength: 128),
                        Project_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.Assigne_Id)
                .ForeignKey("dbo.Projects", t => t.Project_Id)
                .Index(t => t.Assigne_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Tasks", "Assigne_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Tasks", new[] { "Assigne_Id" });
